...
const ZSProvider = (() => {
  ...
  // Scope to the site's composer only; skip Mechablox Connect's own injected textarea
  ...
  function truncateForSend(text) {
    ...
    const marker =
      `\n\n[…Mechablox Connect: result truncated to fit Qwen's ${SEND_CAP}-character input ` +
  ...
  // tool-calls instead of Mechablox Connect commands. Removed 2026-07: the real cause of
